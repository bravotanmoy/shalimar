...
var Grid = (function() {
	...
	Preview.prototype = {
		create : function() {
			...
			this.jQuerytwitter = jQuery('<a href="" class="social"><i class="fa fa-twitter"></i></a>');
			this.jQueryfacebook = jQuery('<a href="" class="social"><i class="fa fa-facebook"></i></a>');
			this.jQueryhref = jQuery( '<a href="#">Visit website</a>' );
			this.jQuerydetails = jQuery( '<div class="og-details"></div>' ).append( this.jQuerytitle, this.jQuerydescription, this.jQuerytwitter, this.jQueryfacebook);
			...
			this.jQuerypreviewInner = jQuery( '<div class="col-md-offset-2 col-md-8"></div>' ).append( this.jQueryclosePreview, this.jQuerydetails );
			this.jQueryrow = jQuery('<div class="row"></div>').append(this.jQuerypreviewInner);
			this.jQuerycontainer = jQuery('<div class="container"></div>').append(this.jQueryrow)
			this.jQuerypreviewEl = jQuery( '<div class="team-extended"></div>' ).append( this.jQuerycontainer );
		...
		update : function( jQueryitem ) {
			...
			var jQueryitemEl = this.jQueryitem.children( 'a' ),
				eldata = {
					...
					twitter: jQueryitemEl.data('twitter'),
					facebook: jQueryitemEl.data('facebook')
				};

			this.jQuerytitle.html( eldata.title );
			this.jQuerydescription.html( eldata.description );
			this.jQuerytwitter.attr('href', 'https://twitter.com/'+eldata.twitter);
			this.jQueryfacebook.attr('href', 'https://www.facebook.com/'+eldata.facebook);
